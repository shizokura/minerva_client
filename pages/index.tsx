...
<section className="relative w-full h-screen flex flex-col items-center justify-center text-center text-white">
    ...
    <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" />
      ...
      {/* Products */}
         ...
         <section className="relative h-60 fr:-top-60 sm:top-96 12:top-96 lt:top-96 lg:top-96 mb-28 flex flex-col items-center justify-center text-center text-white ">
