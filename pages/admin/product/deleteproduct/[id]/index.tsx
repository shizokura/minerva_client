...
const Index: FC =() => {
  ...
  const onSubmitDeleteProduct = async (e: SyntheticEvent) => {
    ...
    const res = await fetch(`https://minervasales-23b0919d60c1.herokuapp.com/product/deleteProduct/${router.query.id}`, {
        method: "DELETE",
  ...
  return (
    <div className={styles.container}>
        <form onSubmit={onSubmitDeleteProduct}>
            <h2>Are you sure do you want to delete this product!</h2>
