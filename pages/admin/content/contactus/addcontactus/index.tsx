...
const AddAppointmentsPage: FC = () => {
  ...
  const AddContactUsForm = async (e :any) => {
  ...
  //   fd.append("tirle", contactUs.title)
  //   fd.append("description", contactUs.description);
  //   fd.append("userID", userid);

  //   const response = await fetch("https://minervasales-23b0919d60c1.herokuapp.com/contact/contactCreate", {
  //     method: "POST",
  //     body: fd
  //   })
    ...
    <div className="flex w-full h-[1050px] bg-gradient-to-r from-amber-200 to-yellow-500 flex-col bg-white bg-clip-border text-gray-700 shadow-md">
            <div className="pt-10 md:pl-96 md:pt-[46px] lt:pl-20 lg:pl-96 sm:pl-24">
                    <div className="p-4 md:p-8">
                        <h1 className="text-black text-center font-bold pb-8 text-4xl md:text-5xl lg:text-6xl">Add Contact Us Content</h1>
                            <form encType='multipart/form-data' onSubmit={AddContactUsForm} className="flex flex-col items-center">
                                    <div className="md:w-4/5 lg:w-3/4 xl:w-2/3">
                                            <div className="flex flex-col md:flex-row">
                                                ...
                                                <input id="title" type="text" name="title"
                                                    ...
                                                    onChange={(e) => setContactUs({...contactUs, title: e.target.value})} required/>
