...
<Modal isOpen={isModalOpen} onClose={handleCloseModal}>
    ...
    <div className="absolute z-20 top-[25px] right-10 flex items-center w-[140px] lg:w-[220px] mx-auto bg-white border-2 border-black rounded-md text-sm " x-data="{ search: '' }">
